...
_GATE_COLUMNS = (
    ...
    "ayla_user_id",
    "accepted_at",
    # Гейт спрашивает его, когда включён флаг личности в каталоге. Столбец
    # заведён здесь ДО включения намеренно: иначе включение флага упало бы
    # ``KeyError`` в проде вместо того, чтобы закрыть продажу.
