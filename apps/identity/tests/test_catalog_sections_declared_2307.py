...
а не «зеркало ↔ каталог». Вторую половину держит живой узел
...
Его запускают вручную с учётными данными стенда (``docs/qa/ayla-e2e-setup.md``):
в CI он пропускается, а стенд ``cross-boundary.yml`` выключен и приколочен к
старому SHA каталога. Автоматического межрепозиторного сторожа пока нет.
"""
