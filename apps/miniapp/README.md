...
число, которое стоит помнить: **правила нашли 46 мест, а подавлений в коде было
26**. Команда подавляла то, что случайно заметила, — двадцать мест не видел
никто. Это измеряет не «правило некому проверить», а **«проверка мнилась там,
где её не было»**.
...
шестнадцать безвредны по замыслу, а в двух **совет правила сломал бы замысел** —
и следующий человек должен видеть «почему», а не только «что».
