 ...
 *
 * Все пять вкладок — корни поверхности (DRF-2201): экран вкладки объявляет
 * `screenRoot(...)`, стрелки «назад» на нём нет (ни нарисованной, ни
 * системной в MAX), уход — соседние вкладки. Перепись в
 * `CustomerTabBar.test.tsx` держит это фактом: кто рисует панель — тот
 * объявил корень.
 */
