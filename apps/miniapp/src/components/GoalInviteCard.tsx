 ...
 * # Дорога к записи
 *
 * Карточка — не модальное окно и не шаг мастера: обычная секция над
 * списком. Табы, список записей, нижняя навигация и «Найти услугу»
 * остаются на месте и работают. Сбой `decision-context` не рисует
 * ничего — домашний экран не имеет права падать из-за необязательного
 * приглашения.
 */
