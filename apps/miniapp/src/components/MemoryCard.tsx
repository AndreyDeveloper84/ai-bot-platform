      ...
      {view !== "error" ? (
        <>
          <p className="profile-support-sheet__body">
            Удалю в течение часа всё, что знаю о тебе, кроме бронирований и оплат,
            — вернуть будет нельзя. Переписка обезличится: текст останется без
            твоих контактов. Избранные мастера останутся в приложении BeautyGO,
