 ...
 *   `apps/orchestrator/tests/test_done_claims_guard_2341.py`. Механизма два
 *   на один класс, и носители у них разные — поле ответа навыка против метки
 *   на прочитанном значении; сводить их в один не надо, но ссылки стоят в обе
 *   стороны, чтобы через месяц один из них не сочли лишним.
