...
describe("первый вход клиента", () => {
  ...
  it("цель есть, а вопросы под неё ещё есть — всё равно домой, к вопросам ведёт карточка цели (DRF-2177)", async () => {
    // Документ с целью теперь несёт её сужающие вопросы (каталог #517).
    // Первый экран — анкета только для того, у кого цели НЕТ; иначе
    // человек с целью попадал бы на вопрос вместо главного при каждом
    // открытии.
