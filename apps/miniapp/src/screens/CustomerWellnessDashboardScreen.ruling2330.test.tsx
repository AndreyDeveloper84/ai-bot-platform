 ...
 *
 * Источник: `docs/OPEN_DECISIONS.md`, **§172** — решение владельца 22.09 по
 * расхождениям макета H01 (DRF-1321 v1.2, PR #1894) и ответы 23.09 на
 * вопросы 39–43. § заведён этим же PR: до него решение жило только в
 * переписке, а прежние ссылки вели на два файла, которых в репозитории нет
 * (проверено по рабочему дереву и по `origin/dev`).
 *
 * Что закрепляется:
 *
