 ...
 *
 * Д31 (г) 22.09: полка уходит с экрана. **Вопрос 40 отвечен 23.09 (§61
 * `docs/CURRENT_DECISIONS_2026-09-16.md`): оставить обездвиженной, код не
 * удалять.** То есть это не ожидание ответа, а сам ответ: константа стоит
 * здесь по решению, а не «пока».
 *
