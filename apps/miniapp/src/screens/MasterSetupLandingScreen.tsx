...
/**
 * Чем полоса готовности объявляется вслух, когда часть шагов ведётся не
 * здесь (DRF-2350). Знаменатель полосы — достижимые шаги, поэтому при двух
 * недоступных пунктах диктор читал «сто процентов», хотя настроено не всё:
...
export const BAR_PARTLY_ELSEWHERE_TEXT =
  "Настроено всё, что настраивается здесь. Остальные шаги ведутся не в приложении.";
  ...
  return (
    <main className="screen setup-landing" aria-labelledby="setup-landing-title">
      ...
      <div
        ...
        {...(elsewhere.length > 0 ? { "aria-valuetext": BAR_PARTLY_ELSEWHERE_TEXT } : {})}
