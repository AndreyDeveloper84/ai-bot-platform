...
# ─── DRF-2288 (решение владельца №41, CD §76) — ориентиры Ж и У ─────────────
#
# Живой проход 22.09 (DRF-2281, находка 4): «Б 0 / 123 · Ж 0 · У 0 г» —
# ориентир был только у белка. Жиры и углеводы — тем же признаком
# происхождения калорий, что белок (DRF-1844), каждый ключ сам по себе.
# Узлы живут здесь, а не отдельным файлом: этот файл — в списке стабов
# «ориентир ЕСТЬ» сторожа ``tools/lint/nutrition_target_guard.py``.
