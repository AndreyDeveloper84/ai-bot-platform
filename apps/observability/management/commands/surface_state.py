...
уронил бы следующий ``git checkout dev`` — «local changes would be
overwritten» — на шаге ДО миграций (находка ayla-3b, 11.09.2026).
    ...
    def add_arguments(self, parser) -> None:
        parser.add_argument(
            ...
            help=(
                ...
                "docs/generated/SURFACE_STATE.md — путь игнорируется git: это "
                "замер, а не исходник). Файл целиком заменяется; заголовок "
                "предупреждает о правке руками."
            ),
        )
