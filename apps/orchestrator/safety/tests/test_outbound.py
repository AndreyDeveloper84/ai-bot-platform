    ...
    **ноль правил**. Здесь не было категории. Значит «между курсами нужно
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # «день» в именительном падеже: беглая гласная разрывает
            # основу, и первая редакция шаблона пропускала обе строки
            # ниже — молча, как и положено ложному пропуску.
            "За день до процедуры не загорайте.",
            "Приходить нужно каждый день.",
        ],
    )
