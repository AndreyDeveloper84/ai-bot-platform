...
class TestWhatStoppedBeingTakenForAPhone:
    ...
    def test_a_sha256_hash_is_not_a_phone(self) -> None:
        ...
        (найдено ревью)."""
        # Синтетический дайджест: ничего не хэширует и ничего не открывает, но
        # нужен именно длиной и составом — на 64 hex-символах шаблон и ошибался.
        # Одна строка, а не склейка: оговорка сканера секретов должна стоять на
        # той же строке, где литерал, а форматтер склейку переносит.
        digest = "5316e540ee22f6180fb89492904051b3" * 2  # pragma: allowlist secret
    ...
    def test_an_archive_of_a_person_who_has_a_phone_on_file_passes(self) -> None:
        ...
        """
        digest = "88820462180e5c893eff" + "0" * 44  # pragma: allowlist secret
