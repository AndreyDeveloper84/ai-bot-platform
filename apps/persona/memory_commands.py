...
_FACT_KEYWORDS: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("diet", "halal"): ("халял",),
    ("diet", "kosher"): ("кошер",),
    # DRF-2398: без этих двух «забудь, что я ем всё» не попадало в конкретный
    ...
    ("diet", "omnivore"): ("ем всё", "ем все", "без ограничений", "всеядн"),
    ("diet", "other"): ("особое питание", "особая диета"),
}
