...
-----------------------------------
Есть другие подходы — кадр C04.2 макета дословно, кнопка на каждый.
...
заглушка: второго направления нет, и бот этого не скрывает. Кадр C04.3
...
#: C04.2 при ОДНОМ направлении — честно: другого пока нет, путь — своими словами.
ALT_STUB_TEXT = (
