"""C04.3 «другие подходы» и сторож по предмету (DRF-1770, К-3 N4).
...
2. кадр C04.3 по макету DRF-1270 дословно: «Есть несколько подходящих
...
**Предел:** «Показать больше причин» (C04.2) остаётся отсутствием —
