...
class Tenant(models.Model):
    ...
    #
    # * ``NULL``  — источник об адресе НИЧЕГО не сказал. Сегодня это все
    #   салоны: ключ ``tenant_address`` в фиде специалистов ещё не заведён
    #   (его заводит DRF-1587), и подставлять вместо него что-либо —
