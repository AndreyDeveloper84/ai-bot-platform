...
| **Дизайн каталога: DRF-67, DRF-1180** | ассайни **<имя>@example.org (замаскировано DRF-1269)** | средний | Экран каталога и карточка мастера с отзывами — их макеты. Не рисовать свои |
