...
```
bot:max:83146139    goal_key=skin_care   выбрана 2026-09-08 18:54 UTC
bot:max:260237491   goal_key=relax       выбрана 2026-09-04 13:55 UTC
bot:max:229831120   goal_key=relax       выбрана 2026-09-08 11:01 UTC
bot:max:66368800    goal=None            (цели нет — честный None)
```
