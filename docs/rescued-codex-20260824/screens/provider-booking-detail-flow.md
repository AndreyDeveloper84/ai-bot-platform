# Provider Booking Detail — Developer Handoff Package
...
| **Scope** | Provider-side booking detail screen: booking status, customer/service recap, client note, Ayla-mediated messages, role-based actions, timeline |
