...
| **Status** | Final draft for Tech Lead review |
...
| **Scope** | Provider-side calendar and schedule flow: day/week view, booking list, manual booking, time block, working hours, day-off, sick day, vacation, stale slot protection |
