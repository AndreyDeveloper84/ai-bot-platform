...
CQ-CTX-01…03 — `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`. Blockers: G7 question contract; вопрос G5 не покрывает глубину / инородное тело / чувствительность; одиночный «нет» на составной вопрос G4. Fixtures `T-S1-RCB-*` (32) — `S1_CONTEXT_RECHECK_ADVERSARIAL_FIXTURES_v0.2.md` v0.2.6.
