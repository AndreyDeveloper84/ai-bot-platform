...
#### Owner amendments 21.09 — G7 question contract (`OWNER POLICY: APPROVED` · `INDEPENDENT PHYSICIAN SIGN-OFF: PENDING`)

Источник — immutable record `docs/safety/reviews/OWNER_RULINGS_S1_G7_QUESTION_CONTRACT_2026-09-21.md` (RECORD SHA-256 `b4f2f3f11045f5527b2c16f616bf4116e15c682ab309e54ccbea1d1f7c3597d9`; ответ владельца `утверждаю`, 21.09.2026), реестр [OD-BOT §170] / [§171]. Формула record r4 не меняется. `question_id: health_screening.g7`, точный текст — «Сейчас есть хотя бы один из признаков: кажется, что вы вот-вот потеряете сознание; трудно самостоятельно стоять, говорить или дышать; появилась спутанность; состояние быстро ухудшается?»; прежняя формулировка record 18.09 («Прямо сейчас тебе трудно дышать, стоять, говорить, ты теряешь сознание или состояние быстро ухудшается?») — историческая. Строки таблицы — `ENGINEERING ELABORATION OF OWNER RULING`; дословный текст — в record; ни одна строка не является physician verdict.
...
Owner blocker «G7 question contract не зарегистрирован» (блок 21.09 ниже) — снят. Fixtures `T-S1-G7Q-*` (25) — v0.2.7. Runtime `health_screening.g7` не реализован.

#### Owner amendments 21.09 — `safety_recheck` clinical boundaries G1–G7 (`OWNER POLICY: APPROVED` · `INDEPENDENT PHYSICIAN SIGN-OFF: PENDING`)

Источник — immutable record `docs/safety/reviews/OWNER_RULINGS_S1_RECHECK_CLINICAL_BOUNDARIES_2026-09-21.md` (RECORD SHA-256 `cf0263dd5d890217e534817ab6fc7ece15af3cbbddfceb827c557c52f15af094`; ответ владельца `утвержда.`, 21.09.2026), реестр [OD-BOT §168] / [§169]. Уточняет клиническую применимость формулы record r4 (блок выше), не меняет её; строки таблицы — `ENGINEERING ELABORATION OF OWNER RULING`, дословный текст — в record; ни одна строка не является physician verdict. `EVIDENCE_CORRECTION` ≠ `SYMPTOM_UPDATE`; односложные / generic ответы → `UNKNOWN`.
...
CQ-CTX-01…03 — `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`. Blockers: G7 question contract (owner blocker снят 21.09, [OD-BOT §170]); вопрос G5 не покрывает глубину / инородное тело / чувствительность; одиночный «нет» на составной вопрос G4. Fixtures `T-S1-RCB-*` (32) — `S1_CONTEXT_RECHECK_ADVERSARIAL_FIXTURES_v0.2.md` v0.2.6.
...
| 0.12-reviewfix8 (owner G7 question contract 21.09) | 2026-09-21 | **G7 question contract.** Ответ владельца `утверждаю` на решения G7 1–5 зарегистрирован в immutable record `docs/safety/reviews/OWNER_RULINGS_S1_G7_QUESTION_CONTRACT_2026-09-21.md` (RECORD SHA-256 `b4f2f3f11045f5527b2c16f616bf4116e15c682ab309e54ccbea1d1f7c3597d9`); §6.1 «Owner amendments 21.09 — G7 question contract»; `health_screening.g7` — точный текст; три структурированных ответа; fixtures v0.2.7 (+25 `T-S1-G7Q-*`, итог 150). Формула r4, owner-блоки, семь групп, четыре состояния — без изменений. `INDEPENDENT PHYSICIAN SIGN-OFF: PENDING`; `CONTROLLED PILOT S1 GATE — NOT READY`; runtime не менялся. Предыдущая версия 0.12-reviewfix7 — sha256 `7316d626180d9b99c6a1a2cb84b8bf58307cbf1325036060cce2ee54f712b9e1`. Статус — `WORKING DRAFT` | Safety Reconciliation Orchestrator |
| 0.12-reviewfix7 (owner clinical pre-review 21.09) | 2026-09-21 | **Клинические границы `safety_recheck` G1–G7.** Ответ владельца `утвержда.` на решения 1–5 зарегистрирован в immutable record `docs/safety/reviews/OWNER_RULINGS_S1_RECHECK_CLINICAL_BOUNDARIES_2026-09-21.md` (RECORD SHA-256 `cf0263dd5d890217e534817ab6fc7ece15af3cbbddfceb827c557c52f15af094`); §6.1 «Owner amendments 21.09» (таблица G1–G7, blockers); CQ-CTX-01…03 — `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`; fixtures v0.2.6 (+32 `T-S1-RCB-*`, итог 125). Формула r4, owner-блоки §6.1–6.10, OD-SAF-11…22, семь групп, четыре состояния — без изменений. `INDEPENDENT PHYSICIAN SIGN-OFF: PENDING`; `CONTROLLED PILOT S1 GATE — NOT READY`; runtime не менялся. Предыдущая версия 0.12-reviewfix6 — sha256 `82235c1942f783a465b45759e6f07686106b36fed8483d10b49ad9dd739bf93c`. Статус — `WORKING DRAFT` | Safety Reconciliation Orchestrator |
