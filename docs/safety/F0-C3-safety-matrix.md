...
Источник — immutable record `docs/safety/reviews/OWNER_RULINGS_SAFETY_RECHECK_CONTRACT_2026-09-20.md` (RECORD SHA-256 `e7b54cc3d9a27c6a067d54b7e725122093ca630f59abced86af7ce23b25a6ff1`), реестр [OD-BOT §166] / [§167], engineering rendering — `docs/safety/reviews/AYLA_S1_SAFETY_RECHECK_CONTRACT_DELTA_v0.1_2026-09-20.md`. Уточняет [§156] / [§162], не отменяет; семь групп, четыре состояния, owner-блок выше — **не меняются**. Регистрация контракта, не разрешение включить runtime (Пакет B); ни одна строка не является physician verdict.
