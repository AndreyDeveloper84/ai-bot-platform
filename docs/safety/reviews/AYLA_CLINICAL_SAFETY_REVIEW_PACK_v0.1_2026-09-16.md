...
**Версия:** v0.1-reviewfix8 (2026-09-21) — owner G7 question contract 21.09 (`утверждаю`; [OD-BOT §170–§171]; immutable record `docs/safety/reviews/OWNER_RULINGS_S1_G7_QUESTION_CONTRACT_2026-09-21.md`, RECORD SHA-256 `b4f2f3f11045f5527b2c16f616bf4116e15c682ab309e54ccbea1d1f7c3597d9`): новый §7F; в §7E owner blocker G7 question contract отмечен снятым; статусы CQ-CTX-01…03 / 08 / 09, clinical questions, роль врача — без изменений; предыдущая версия v0.1-reviewfix7 — sha256 `73b0e8d8d1502fee72e5ed1d01c18f20f393606fefbe6217b48ffaff1009ab64`. v0.1-reviewfix7 (2026-09-21) — owner clinical pre-review 21.09 (`утвержда.`; [OD-BOT §168–§169]; immutable record `docs/safety/reviews/OWNER_RULINGS_S1_RECHECK_CLINICAL_BOUNDARIES_2026-09-21.md`, RECORD SHA-256 `cf0263dd5d890217e534817ab6fc7ece15af3cbbddfceb827c557c52f15af094`): новый §7E (границы G1–G7, blockers); статус CQ-CTX-01…03 в §7D → `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`; CQ-CTX-08 / 09, clinical questions, роль врача — без изменений; предыдущая версия v0.1-reviewfix6 — sha256 `8066815aaf4f93a4ebe1ab54affc3c20a0fb53e1c774ff7f30a4e748b635be04`. v0.1-reviewfix6 (2026-09-21) — record r4 (`PROVENANCE-ONLY CORRECTION`): источник §7D переведён на `docs/safety/reviews/OWNER_RULINGS_SAFETY_RECHECK_CONTRACT_2026-09-20_r4.md` (RECORD SHA-256 `2245924e6f551cb5dd84a4e67f50093a1ec2a64646408881449281f1d64a7ef0`); r3 — `SUPERSEDED BY r4 — provenance-only correction`; вопросы §7D, clinical questions, G1–G7, роль врача — без изменений; предыдущая версия v0.1-reviewfix5 — sha256 `2373a9ece4bdc1b217b72b8deb814104ab6cd1c31f78b21f08295027de11d5a6`. v0.1-reviewfix5 (2026-09-20) — record r3 (canonical owner wording): источник §7D переведён на `docs/safety/reviews/OWNER_RULINGS_SAFETY_RECHECK_CONTRACT_2026-09-20_r3.md` (RECORD SHA-256 `4935e344689632cf41ce6622198d70ebbfd87fd4ccb740a8930c5df31e3c3aaf`); формулировки вопросов §7D — `ENGINEERING ELABORATION OF OWNER RULING` поверх утверждённого владельцем «подготовить вопросы врачу CQ‑CTX‑01…03»; сами вопросы, clinical questions, G1–G7 и роль врача — без изменений; r1 и r2 — `SUPERSEDED BY r3`; предыдущая версия v0.1-reviewfix4 — sha256 `9eba18ea7b425c6ce92b28f3efafadd3d4f87e88288b11d075792d9356c11c77`. v0.1-reviewfix4 (2026-09-20) — record r2: источник §7D переведён на superseding immutable record `docs/safety/reviews/OWNER_RULINGS_SAFETY_RECHECK_CONTRACT_2026-09-20_r2.md` (RECORD SHA-256 `0f5324eca27544768739f4eb6d3a24c4a019848dda65ec8d35e16d63596049e8`; дословный ответ владельца «согласен, утверждаем»; r1 — `SUPERSEDED BY r2`); вопросы §7D, clinical questions, G1–G7, роль врача — без изменений; предыдущая версия v0.1-reviewfix3 — sha256 `1bb46d6895726e5c5540694b2280976506ba74fd6cc8ab5bc9e1d7773b1d817e`. v0.1-reviewfix3 (2026-09-20) — owner recheck contract 20.09 внесён как `OWNER APPROVED — PENDING PHYSICIAN CONFIRMATION` (§7D; [OD-BOT §166–§167]); physician queue CQ-CTX-01…03 переформулирована под контракт и **остаётся открытой**; clinical questions, G1–G7, роль врача — без изменений; предыдущий sha256 файла `51f60dba57c547e5bb9c04a159608583acc7c3452b8e7fbb943a2e4c793c9a1e`. Ранее: v0.1-reviewfix2 (2026-09-18) — owner delta 18.09 внесён как `OWNER APPROVED — PENDING PHYSICIAN CONFIRMATION` (§7C; [OD-BOT §159–§165]); clinical questions, G1–G7, роль врача — без изменений; предыдущий sha256 файла `79a9c144190f79d2d3a6f8a4689c2a7dedada880db1710484a087b85dc9cb110` (PR #1829). Ранее: v0.1-reviewfix1 (2026-09-17) — documentation-only pre-physician reconciliation: терминология и роли синхронизированы с fixture-артефактами и матрицей; medical semantics и fixtures не менялись. Предыдущий sha256 файла: `998c7f657f85637a02c90194c5a11e507df4265777184401c827d6d248b90f3c`.\
...
**Статус:** `OWNER APPROVED — PENDING PHYSICIAN CONFIRMATION` · `CONTROLLED PILOT S1 GATE — NOT READY`. Владелец 20.09 зарегистрировал product-контракт выхода из S1-ограничения (дословный ответ владельца «согласен, утверждаем», 20.09.2026; действующий immutable record r4 `docs/safety/reviews/OWNER_RULINGS_SAFETY_RECHECK_CONTRACT_2026-09-20_r4.md`, RECORD SHA-256 `2245924e6f551cb5dd84a4e67f50093a1ec2a64646408881449281f1d64a7ef0`; r3 — `SUPERSEDED BY r4 — provenance-only correction`; r1 и r2 — superseded transmission drafts; [OD-BOT §166–§167]): единственная явная точка входа `safety_recheck.start`; формула `CLEARED_BY_RECHECK = ANY(1..5) AND ALL(6..8)` (основания 1–5 — альтернативные; guards 6–8 — обязательные); `open` разрешается только зарегистрированным вопросом с однозначным `OUTSIDE_S1`, `stop` — только полным recheck; audit / provenance record без сырого текста. Это **не** просьба подтвердить архитектуру: владелец и Safety решают точку входа, provenance и carrier. Врачу — только клиническая достаточность. Owner approval **не закрывает** ни один пункт ниже; runtime (Пакет B) не включается до их ответа.

| ID | Вопрос врачу | Фикстуры | Статус |
|---|---|---|---|
| CQ-CTX-01 | Для каких групп G1–G7 product recheck (снятие продуктового блокиратора по новой явной самооценке) вообще допустим? Для каких — никогда (только медицинская помощь)? | REC-ALLOW-01…08 (`clinical_contract_permits_clearance`), RES-G1…G7 | `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF` (§7E; RCB-*) |
| CQ-CTX-02 | Минимальный набор recheck-вопросов для каждой допустимой группы (один вопрос, не анкета) | R09–R12, REC-ALLOW-08 | `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF` (§7E; RCB-*) |
| CQ-CTX-03 | Какие ответы достаточны для `OUTSIDE_S1` / `CLEARED_BY_RECHECK`; какие recent-resolved случаи исключают clearance независимо от ответа (guard 8) | REC-DENY-01…08, RES-G3 / G4 / G6, R09 | `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF` (§7E; RCB-*) |
...
# 7E. Owner-approved clinical boundaries `safety_recheck` G1–G7 (21.09.2026) — что остаётся врачу

**Статусы:** `OWNER POLICY: APPROVED` · `CLINICAL PRE-REVIEW: COMPLETE` · `INDEPENDENT PHYSICIAN SIGN-OFF: PENDING` · `CLINICAL APPROVED: NO` · `PHYSICIAN PASS: NO` · `SAFE FOR PILOT: NO` · `CONTROLLED PILOT S1 GATE READY: NO`. Источник — immutable record `docs/safety/reviews/OWNER_RULINGS_S1_RECHECK_CLINICAL_BOUNDARIES_2026-09-21.md` (RECORD SHA-256 `cf0263dd5d890217e534817ab6fc7ece15af3cbbddfceb827c557c52f15af094`; ответ владельца `утвержда.`); [OD-BOT §168–§169]. Владелец утвердил продуктовую политику; это **не** заключение лицензированного врача, и физиологическая достаточность границ ниже остаётся предметом независимого врачебного sign-off.
...
Clinical rationale (supporting only; проверено 21.09.2026): NHS — Chest pain, Shortness of breath, Fainting, Anaphylaxis, Cuts and grazes — подтверждено; AHA — Warning signs of a heart attack и ASA — Stroke symptoms — страницы автоматически недоступны (HTTP 403), выводы не перепроверены (формулировки и ссылки — в record).

Что просим врача подтвердить или изменить (CQ-CTX-01…03, статус `OWNER_POLICY_RESOLVED / PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`): границы G1–G7 выше; достаточность пяти элементов реш. 3; перечень recent-resolved, исключающих clearance (реш. 4), и исключение G5. Fixtures — `T-S1-RCB-*` (32: ALLOW 11 / DENY 12 / UNKNOWN 9), clinical `PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`. Blockers: G7 question contract (owner blocker снят 21.09 — §7F, [OD-BOT §170]); вопрос G5 не покрывает глубину / инородное тело / чувствительность; одиночный «нет» на составной вопрос G4.
# 7F. Owner-approved G7 question contract (21.09.2026) — что остаётся врачу

**Статусы:** `OWNER POLICY: APPROVED` · `INDEPENDENT PHYSICIAN SIGN-OFF: PENDING` · `CLINICAL APPROVED: NO` · `PHYSICIAN PASS: NO` · `SAFE FOR PILOT: NO` · `CONTROLLED PILOT S1 GATE READY: NO`. Источник — immutable record `docs/safety/reviews/OWNER_RULINGS_S1_G7_QUESTION_CONTRACT_2026-09-21.md` (RECORD SHA-256 `b4f2f3f11045f5527b2c16f616bf4116e15c682ab309e54ccbea1d1f7c3597d9`; ответ владельца `утверждаю`); [OD-BOT §170–§171]. Владелец утвердил продуктовый контракт; это не заключение лицензированного врача.
...
Supporting rationale (не physician sign-off; проверено 21.09.2026): NHS — Sepsis (https://www.nhs.uk/conditions/sepsis/) — среди поводов для экстренной помощи названы, в частности, затруднение дыхания и спутанность / невнятная речь. Сепсис не диагностируется; дополнительные признаки из источника в контракт не переносятся.

Что просим врача подтвердить или изменить: точный текст вопроса и его достаточность как единственного G7-вопроса; перечень «не G7»; три структурированных ответа и то, что свободный текст не эквивалентен ответу 2. Fixtures — `T-S1-G7Q-*` (25: ALLOW 10 / DENY 9 / UNKNOWN 6), clinical `PENDING_INDEPENDENT_PHYSICIAN_SIGNOFF`. Wording — также Legal (как CQ-CTX-08).
