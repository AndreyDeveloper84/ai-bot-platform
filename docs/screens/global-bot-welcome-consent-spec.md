...
## 3. Soft-gate (Variant A — зафиксировано; legal ACK #947 pending)
...
## 4. Welcome (первое касание) — голос зафиксирован
...
**Timing (зафиксировано 2026-07-03):** welcome вводит Ayla + **мягко предлагает** согласие (одна строка + кнопки), но **не блокирует** discovery/chat. Жёсткая точка требования — момент, где гейтенная возможность реально включается: **registration в booking-confirm** (уже в его спеке) + **перед первой записью в память**. Т.е. согласие всплывает 2 раза максимум: мягко на welcome, обязательно — на регистрации/memory-write. Без нытья на каждом сообщении.
...
## 11. Решения (зафиксировано 2026-07-03 founder)
