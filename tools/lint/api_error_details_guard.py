...
Долг найден листом DRF-2373 (перепись) и сокращается листом **DRF-2439**:
чинить все клиенты в листе про подтверждение значило бы спрятать восемь
правок за чужим заголовком.
